...
<div class="misc-awards-list">
  <section class="misc-awards-group" aria-label="Academic and research honors">
    ...
    <div class="misc-award-item">
      ...
      <div class="misc-award-date">01/2023</div>
    </div>
    <div class="misc-award-item">
      <div class="misc-award-name">Second Place, OR/MS Tomorrow Mini-poster Competition</div>
      <div class="misc-award-date">12/2022</div>
    </div>
    <div class="misc-award-item">
      <div class="misc-award-name">Winner, INFORMS Social Media Analytics Best Student Paper Award</div>
      <div class="misc-award-date">10/2022</div>
    </div>
  </section>

  <section class="misc-awards-group" aria-label="Undergraduate honors">
    <h5 class="misc-awards-group-title">Undergraduate Honors</h5>
    <div class="misc-award-item">
      <div class="misc-award-name">Second Prize, the 7th Beijing College Transportation Technology Competition</div>
      <div class="misc-award-date">11/2017</div>
    </div>
    <div class="misc-award-item">
      <div class="misc-award-name">Tsinghua-Evergrande Group First-Class Scholarship</div>
      <div class="misc-award-date">10/2017</div>
    </div>
    <div class="misc-award-item">
      <div class="misc-award-name">Tsinghua-Zhenli Group Second-Class Scholarship</div>
      <div class="misc-award-date">10/2017</div>
    </div>
    <div class="misc-award-item">
      <div class="misc-award-name">First Place, Structural Design Competition, Tsinghua University</div>
      <div class="misc-award-date">12/2016</div>
    </div>
    <div class="misc-award-item">
      <div class="misc-award-name">Third Prize, the 10th National College Structural Design Competition</div>
      <div class="misc-award-date">10/2016</div>
    </div>
    <div class="misc-award-item">
      <div class="misc-award-name">China National Scholarship (top 1%)</div>
      <div class="misc-award-date">10/2015</div>
    </div>
    <div class="misc-award-item">
  ...
  <section class="misc-awards-group" aria-label="Earlier competitions">
    <h5 class="misc-awards-group-title">Earlier Competitions</h5>
    <div class="misc-award-item">
      <div class="misc-award-name">First Prize, China High School Biology Olympiad (Provincial)</div>
      <div class="misc-award-date">06/2013</div>
    </div>
    <div class="misc-award-item">
      <div class="misc-award-name">Second Prize, National Olympiad in Informatics in Provinces</div>
      <div class="misc-award-date">03/2012</div>
    </div>
  </section>
</div>
