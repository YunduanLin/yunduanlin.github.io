...
Assert-NotContains "_pages/teaching.md" "The Chinese University of Hong Kong, DOT Department" "Teaching page mentoring section should not group mentees under a shared institution line."
