...
Assert-Contains "assets/js/paper-network.js" "paper-network-centrality-definitions" "Paper network script should explain the centrality measures under the network role panel."
Assert-Contains "assets/js/paper-network.js" "Degree centrality" "Paper network script should define degree centrality for readers."
Assert-Contains "assets/js/paper-network.js" "Connectivity" "Paper network script should define connectivity for readers."
Assert-Contains "assets/js/paper-network.js" "Bridge" "Paper network script should define bridge centrality for readers."
...
Assert-Contains "_sass/_base.scss" "\.paper-network-centrality-definitions" "Styles should define centrality definitions under the network role rows."
...
Assert-Contains "_sass/_base.scss" "min-height:\s*32rem" "Paper network graph should be enlarged in the full-width layout."
