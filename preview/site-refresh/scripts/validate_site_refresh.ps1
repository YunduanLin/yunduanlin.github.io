...
Assert-NotContains "_includes/paper_network.liquid" "paper-network-detail-features|Selected paper features" "Selected-paper card should not display keyword chip groups."
...
Assert-NotContains "assets/js/paper-network.js" "renderFeatures|detail\.features|paper-network-feature" "Paper network script should not render keyword chips in the selected-paper card."
...
Assert-NotContains "_sass/_base.scss" "paper-network-feature|paper-network-topic|publication-keyword" "Styles should not keep visible keyword chip rules."
