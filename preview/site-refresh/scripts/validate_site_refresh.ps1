...
Assert-Contains "_pages/about.md" "profile_layout:\s*sidebar" "Homepage should use the sidebar profile layout."
...
Assert-Contains "_layouts/about.liquid" "home-profile-layout" "About layout should support the homepage profile grid."
Assert-Contains "_sass/_base.scss" "\.home-profile-layout" "Styles should define the homepage profile grid."
