...
Assert-Contains "_sass/_variables.scss" '\$blue-color:\s*#1f5fa8' "Theme variables should use a CUHK-inspired deep blue."
Assert-Contains "_sass/_variables.scss" '\$blue-color-dark:\s*#173f73' "Theme variables should use a deeper blue for dark accents."
Assert-Contains "_sass/_variables.scss" '\$cyan-color:\s*#6f7fc8' "Dark mode theme color should stay in the purple-blue family."
Assert-Contains "_sass/_themes.scss" '--global-theme-color:\s*#\{\$purple-color\}' "Light theme should use purple as the primary accent."
Assert-Contains "_sass/_themes.scss" '--global-hover-color:\s*#\{\$blue-color\}' "Light theme hover accent should use blue."
Assert-Contains "_sass/_base.scss" "#1f5fa8" "Homepage and research accents should include the new deep blue."
Assert-NotContains "_sass/_base.scss" "#b8892f|#2f6f6f|#244f4f|#536d8f|#7a5b18" "Custom page styling should not keep the previous green/gold palette."
...
Assert-Contains "_pages/research.md" "(?s)Journal Publications & Manuscripts.*Refereed Conference Proceedings.*Work In Progress.*Grants" "Research page should list grants after the paper sections."
