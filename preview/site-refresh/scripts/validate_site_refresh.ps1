...
Assert-Contains "_bibliography/papers.bib" "(?s)@article\{lin2025nonprogressive,[^@]*label=\{J1\}" "Published Management Science paper should be labeled as J1."
Assert-Contains "_bibliography/papers.bib" "(?s)@article\{lin2024content,[^@]*label=\{J2\}" "Published MSOM paper should be labeled as J2."
Assert-Contains "_bibliography/papers.bib" "(?s)@article\{lin2020traffic,[^@]*label=\{J3\}" "Published Accident Analysis & Prevention paper should be labeled as J3."
...
Assert-Contains "_bibliography/papers.bib" "(?s)@article\{chen2026socialspatial,[^@]*label=\{W1\}" "Ready-to-submit manuscript should be labeled as a working paper."
Assert-Contains "_bibliography/papers.bib" "(?s)@article\{dong2026expertise,[^@]*label=\{W2\}" "Under-review manuscript should be labeled as a working paper."
Assert-Contains "_bibliography/papers.bib" "(?s)@article\{zhong2026technology,[^@]*label=\{W3\}" "Major-revision manuscript should be labeled as a working paper."
