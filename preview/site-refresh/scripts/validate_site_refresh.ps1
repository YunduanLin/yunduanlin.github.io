...
Assert-Contains "_pages/teaching.md" ">\s*Current\s*</div>" "Teaching page mentoring section should identify current mentees without repeating PhD inside each row."
