...
Assert-Contains "_includes/paper_network.liquid" "My Publication Network" "Paper network should use the requested section title."
Assert-NotContains "_includes/paper_network.liquid" "Publication Constellation|Explore how individual papers connect through shared questions in diffusion, platform design, learning, and AI-enabled operational analytics\." "Paper network should not keep the old title or description sentence."
...
Assert-Contains "assets/js/paper-network.js" "paper-network-centrality-row" "Paper network script should render centrality rows in the selected-paper card."
...
Assert-Contains "_sass/_base.scss" "(?s)\.paper-network-centrality-matrix\s*\{[^}]*border-top:\s*3px solid #c49a2c" "Centrality matrix should sit inside a purple-gold framed panel."
Assert-Contains "_sass/_base.scss" "(?s)\.paper-network-centrality-title\s*\{[^}]*background:\s*linear-gradient\(90deg,\s*#750f6d,\s*#4b1359\)" "Centrality matrix title should use a purple header bar."
Assert-Contains "_sass/_base.scss" "(?s)\.paper-network-centrality-row-overall\s*\{[^}]*background-color:\s*rgba\(117,\s*15,\s*109,\s*0\.09\)" "Overall centrality row should be visually stronger than the layer rows."
Assert-Contains "_sass/_base.scss" "(?s)\.paper-network-centrality-row-overall\s*\{[^}]*box-shadow:\s*inset 3px 0 0 #c49a2c" "Overall centrality row should carry a gold accent."
