...
Assert-Contains "_pages/teaching.md" ">\s*PhD\s*</h5>" "Teaching page mentoring section should currently group the listed students under PhD."
...
Assert-Contains "_pages/teaching.md" "Co-advisor" "Teaching page mentoring section should include Keyu Chen's co-advisor role."
...
Assert-Contains "_pages/teaching.md" "Advisor" "Teaching page mentoring section should include Chen Chen's advisor role."
Assert-Contains "_pages/teaching.md" "teaching-mentoring-role" "Teaching page should style advisor/co-advisor roles as important mentoring information."
Assert-Contains "_pages/teaching.md" "class=""teaching-current-status"">\s*Current\s*</div>" "Teaching page mentoring section should show current status as a quiet secondary label."
Assert-NotContains "_pages/teaching.md" "class=""teaching-term"">\s*Current\s*</div>" "Teaching page mentoring section should not treat current status like a course term badge."
