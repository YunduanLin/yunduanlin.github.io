...
Assert-Contains "_pages/teaching.md" "6\.80/7\.00" "Teaching page should keep the Berkeley teaching rating for IEOR 253/CEE 258."
...
Assert-NotContains "_pages/teaching.md" "Selected Student Testimonials|Department Average|Enrollment:|Ph\.D\./Master course|Undergraduate course|M\.Eng\. course|I really learn a lot" "Teaching page should remove older detailed course descriptions and testimonials."
