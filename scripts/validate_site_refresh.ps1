...
Assert-Contains "_pages/miscellaneous.md" "<h4 class=""misc-section-heading"">Media Coverage</h4>" "Miscellaneous page should include a real Media Coverage section heading."
...
Assert-Contains "_sass/_base.scss" "(?s)html\[data-theme=`"dark`"\]\s*\{[^}]*\.teaching-institution,\s*\.teaching-course-name,\s*\.misc-award-name,\s*\.misc-media-title\s*\{[^}]*color:\s*var\(--global-text-color\)" "Teaching institution, course titles, award names, and media titles should remain readable in dark mode."
