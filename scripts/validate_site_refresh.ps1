...
Assert-Contains "_includes/paper_network.liquid" "Publication Constellation" "Paper network should use the refined section title."
Assert-Contains "_includes/paper_network.liquid" "Explore how individual papers connect through shared questions in diffusion, platform design, learning, and AI-enabled operational analytics." "Paper network should use the refined description."
