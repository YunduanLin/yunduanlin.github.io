...
Assert-Contains "_pages/research.md" "research-overview" "Research page should begin with a structured overview panel."
Assert-Contains "_pages/research.md" "research-theme-grid" "Research page should render research themes as a compact grid."
...
Assert-Contains "_sass/_base.scss" "\.research-overview" "Styles should define the research page overview panel."
Assert-Contains "_sass/_base.scss" "\.research-theme-grid" "Styles should define the research theme grid."
