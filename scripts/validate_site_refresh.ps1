...
Assert-Contains "_pages/teaching.md" "(?s)Keyu Chen.*Co-advising.*Current PhD" "Teaching page mentoring section should identify Keyu Chen as a current PhD student being co-advised."
...
Assert-Contains "_pages/teaching.md" "(?s)Chen Chen.*Advising.*Current PhD" "Teaching page mentoring section should identify Chen Chen as a current PhD student being advised."
...
Assert-NotContains "_pages/teaching.md" "Co-advisor|>\s*Advisor\s*<|My role:" "Teaching page mentoring role wording should avoid ambiguous advisor labels."
