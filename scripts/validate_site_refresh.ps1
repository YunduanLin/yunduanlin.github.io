...
Assert-Contains "assets/js/paper-network.js" "paper-network-edge-data" "Paper network script should mark data/context similarity edges."
...
Assert-Contains "_sass/_base.scss" "\.paper-network-edge-data" "Styles should color data/context similarity edges."
