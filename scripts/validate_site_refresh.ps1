...
Assert-Contains "_pages/research.md" "ordered from oldest to newest within each section" "Research page should explain that papers are ordered oldest first within each stream."
...
Assert-Contains "_bibliography/papers.bib" "(?s)@article\{lin2024content,.*@article\{lin2025nonprogressive,.*@article\{zhong2026technology,.*@article\{chen2026socialspatial,.*@article\{lin2020traffic,.*@inproceedings\{zheng2020collimatorless,.*@inproceedings\{zhang2024activity,.*@article\{dong2026expertise,.*@article\{zhang2026digitaltwin,.*@article\{xu2026llmagents,.*@inproceedings\{huang2026bilevel,.*@misc\{sun2026allocation," "Bibliography source order should render each research stream from older to newer."
