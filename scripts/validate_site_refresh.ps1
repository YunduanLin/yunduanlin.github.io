...
Assert-Contains "_pages/teaching.md" "DOT Department" "Teaching page mentoring section should identify the DOT Department."
...
Assert-Contains "_pages/teaching.md" "Current PhD" "Teaching page mentoring section should identify current PhD students."
