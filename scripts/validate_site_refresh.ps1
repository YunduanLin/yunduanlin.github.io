...
Assert-Contains "_sass/_base.scss" "(?s)\.home-contact-card\s*\{[^}]*grid-template-columns:\s*minmax\(0,\s*1\.1fr\)\s+minmax\(0,\s*1\.6fr\)\s+minmax\(0,\s*0\.9fr\)" "Homepage contact card should use a full-width three-column desktop layout."
