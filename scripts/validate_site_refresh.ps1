...
Assert-Contains "_data/paper_network.yml" "edges:" "Paper network data should define intellectual links between papers."
...
Assert-Contains "_data/paper_network.yml" "relation:" "Paper network edges should explain why papers are connected."
