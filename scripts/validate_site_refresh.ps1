...
Assert-Contains "_data/paper_network.yml" "SNAP Gowalla" "Pop-up store paper should include the SNAP Gowalla dataset feature."
...
Assert-Contains "_data/paper_network.yml" "(?s)id:\s*J3.*network diffusion.*network structure.*network centrality.*stochastic modeling.*fixed-point iteration.*network game.*equilibrium.*network repository.*Facebook network" "J3 should use the revised network, modeling, equilibrium, and data features."
